...
// void main() => runApp(MySockTestApp());

// const String URI = "http://mapane.smartcodegroup.com/";

// class MySockTestApp extends StatefulWidget {
//   @override
//   _MyAppState createState() => _MyAppState();
// }

// class _MyAppState extends State<MySockTestApp> {
...
//         enableLogging: false,
//         transports: [Transports.POLLING, Transports.WEB_SOCKET] //Enable required transport
//     ));
...
//     socket.connect();
//     socket.on("createAlertNo", (data) => pprint(data));
//     socket.on("createAlertOkUser", (data){   //sample event
// 		  pprint("createAlertOkUser");
// 		  pprint(data);
// 		});
...
//           "long": -121.8129364,
//           "desc": "test",
//           "postedBy": "60128cb68f3e902d60579856",
//           "category": "embouteillage3",
//           "address": "addersse makepe mond unique"
//         })
//       ]);
