...
class _MyAppState extends State<NumeroGet> {
  ...
  Future<void> initMobileNumberState() async {
    ...
    setState(() {
      ...
      if (_simCard.where((i) => i.number != "").toList().length == 0) {
        print("il y'a phone");
        select_number = false;
      } else {
        print("il y'a pas phone");
        select_number = true;
      }
    });
  }
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Column(
                        children: [
                          Text(Languages.of(context).acceptcondterm,
                          ...
                          GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Text(Languages.of(context).termandcond,
                                  textAlign: TextAlign.center,
                                  maxLines: 3,
                                  softWrap: true,
                                  style: TextStyle(
                                      fontSize:
                                          getSize(10.5, "height", context),
                          ...
                          child: RaisedButton(
                            onPressed: () {
                              if (!validated && _mobileNumber.length <= 3) {
                                ...
                                userService
                                    .registerUser(
                                        select_number ? _mobileNumberPhone : '',
                                        !select_number
          ...
          (SimCard sim) => Column(
            children: [
              sim.number != "" && sim.number != null
                  ? ListTile(
                      leading: Text(
                          sim.countryIso.toUpperCase().replaceAllMapped(
                              RegExp(r'[A-Z]'),
